...
; Apparently during the read-out of the tape two numbers were replaced with the non-executing characters '|'' and '$'.
; Which integers do these two need to become to make the code return the value 832040?"
